...
{\em If you created SLCs with ROI\_PAC using raw data, skip Sections: \ref{sec:slcread1} and \ref{sec:slcread2} .}

Currently, scripts exist for pre-processing (reading and cropping) single look complex (SLC) products from ERS, Envisat, RADARSAT-1 and TerraSAR-X satellites.

 In your processing directory, for example, under /d2/iceland\_volcanos/\\
 \cs{mkdir SLC}\\
 \cs{cd SLC}\\
 \cs{mkdir} \cc{yyyymmdd}
