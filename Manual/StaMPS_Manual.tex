...
{\sffamily\Huge{\textbf{\textsc{\\}}}}
  ...
  {\sffamily\Huge{\textbf{{\\
   StaMPS/MTI  Manual\\
     ...
     \vspace{5mm}
     {\sffamily\Large{\textbf{Version 4.0}}}
\vspace{5mm}
...
%\begin{flushright}
\begin{center}
{\sffamily\textbf{Andy Hooper, David Bekaert, Karsten Spaans and Ekbal Hussain}}\\
\vspace{4mm}
{\sffamily\textbf{30th June, 2018}}
%\end{flushright}
\end{center}
...
There are two potential pre-processing steps before getting to the PS/MTI processing proper. The first is to focus the raw data (if required), and the second is to form interferograms from single-look complex (SLC) images. Various processors can be used to achieve the pre-processing including ISCE, SNAP, GAMMA, and ISCE, ROI\_PAC and DORIS. Further details are provided in Chapter~\ref{ch:preproc} for each software.
...
\chapter{Installation}
 ...
 Install StaMPS/MTI: \\
 \cs{ tar -xvf StaMPS\_v4.0b6.tar}\\
 cd StaMPS\_v4.0b6/src\\
 make\\
 make install
...
\section{Small Baseline Processing}
