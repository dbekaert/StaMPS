...
for each scene and within this directory create symbolic links to the raw data (and leader/volume files if they exist). For ERS and RADARSAT-1 data the link names must be {\tt DAT\_01.001}, {\tt  LEA\_01.001}, and {\tt VDF\_DAT.001}. For Envisat  data the link name must be {\tt image.slc}. For TerraSAR-X data, the link names must be {\tt image.slc} and {\tt leader.xml}.
