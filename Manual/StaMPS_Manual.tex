...
In the {\tt INSAR\_}\cc{master\_date} directory run
 \cs{mt\_prep}  for ROI\_PAC/DORIS,  \cs{mt\_prep\_gamma} for Gamma, and  \cs{mt\_prep\_isce} for ISCE. For example:  \\
...
\item Update the manual to support various InSAR processors (ISCE, gamma, DORIS)
