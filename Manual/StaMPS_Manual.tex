...
{\sffamily\Huge{\textbf{\textsc{\\}}}}
  ...
  {\sffamily\Huge{\textbf{{\\
   StaMPS/MTI  Manual\\
     ...
     \vspace{5mm}
     {\sffamily\Large{\textbf{Version 3.2 : NOTE updating to version 3.3}}}
\vspace{5mm}
...
\section{Version 3.3}
\begin{itemize}
\item Update the manual with extra tips.
\item Expand the Small Baselines chapter.
\item Update the shell scripts to allow for batch processing.
\end{itemize}
