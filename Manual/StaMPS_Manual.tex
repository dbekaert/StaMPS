...
\subsection{SNAP}
StaMPS is also compatible with the output generated by the ESA SentiNel Application Platform (SNAP) after the version 6.0 (SNAP can be downloaded from 
...
\subsection{SNAP}
Details on installation and usage of the ESA SentiNel Application Platform (SNAP) can be found at \url{http://step.esa.int/main/download/} while the additional software package for the interferometric stack computation can be found at: \url{https://github.com/mdelgadoblasco/snap2stamps/}
...
First, create single master interferograms by following the pre-processing Chapter of your preferred InSAR processor, i.e. chapter ~\ref{ch:roipac_doris_IFG} for ROI\_PAC/DORIS,  chapter ~\ref{ch:SNAP_IFG} for SNAP,  chapter ~\ref{ch:isce_IFG} for ISCE or chapter ~\ref{ch:gamma_IFG} for Gamma. 
