...
Demonstration about the ESA SNAP and StaMPS compatibility for PSI analysis has been already shown in EGU2018 and IGARSS 2018 with the work done under the title: "ESA SNAP – STAMPS INTEGRATED PROCESSING FOR SENTINEL-1 PERSISTENT SCATTERER INTERFEROMETRY" with Michael Foumelis and José Manuel Delgado among the authors.

When using this software package for SNplease reference \cite{Foumelis2018}
